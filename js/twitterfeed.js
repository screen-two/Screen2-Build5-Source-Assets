...
$.fn.twitterFeed = function(options) {
 	 ...
 	 var settings = $.extend({
		...
		var showdirecttweets = settings.showdirecttweets;
		var showretweets = settings.showretweets;
		var showtweetlinks = settings.showtweetlinks;
		var showprofilepic = settings.showprofilepic;
...
/*$(document).ready(function () {
    var displaylimit = 3;
    var twitterprofile = "thisdigitalinc";
	var screenname = "Digitalinc";
